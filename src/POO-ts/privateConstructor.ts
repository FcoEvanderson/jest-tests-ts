...
// Singleton: cria somente uma instância de determinada classe
// Factory Method: Um método dentro da classe que cria um novo objeto
...
const db4 = Database.getDatabase('localhost', 'root', '12345')
db4.connect()
